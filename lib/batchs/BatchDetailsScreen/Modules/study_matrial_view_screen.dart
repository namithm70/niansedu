...
class StudyMatrialViewScreen extends StatefulWidget {
  final String batchid;

  const StudyMatrialViewScreen({super.key, required this.batchid});

  @override
  State<StudyMatrialViewScreen> createState() => _StudyMatrialViewScreenState();
}

class _StudyMatrialViewScreenState extends State<StudyMatrialViewScreen> {
  late PageController pController;
  BatchStudyController _batchVideoController = Get.put(BatchStudyController());
          ...
          children: [
            Column(
              children: [
                ...
                search_text_field(),
                SizedBox(height: 20.h),
                _batchVideoController.batchVideoStudyMatrialDataModel.data != null
                    ? Expanded(
                                    ...
                                    child: Container(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Expanded(
                                            child: Text(
                                              _batchVideoController.batchVideoStudyMatrialDataModel.data?.chapterListForUser?[index].chaptersTitle ??
                                                  '',
                                              style: TextStyle(
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: TextFormField(
            ...
            onChanged: (value) {
              _batchVideoController.batchVideoListApi(widget.batchid, value);
            },
