                      ...
                      child: ListView(
                        ...
                        children: [
                          ...
                          Wrap(
                            ...
                            children: [
                              for (final i in List.generate(categoryList.length, (index) => index))
                                Padding(
                                  padding: EdgeInsets.only(top: 12.h, bottom: 12.h, right: 3.w, left: 3.w),
                                  child: Wrap(
                                    children: [
                                      GestureDetector(
                                        onTap: () {
                                        ...
                                        child: Container(
                                          ...
                                          decoration: BoxDecoration(
                                            color: selectedCategory.contains(categoryList[i]) ? Color(0XFFE5ECFF) : Colors.white,
                                            borderRadius: BorderRadius.circular(6.h),
                                            border: Border.all(
                                                color: selectedCategory.contains(categoryList[i]) ? Color(0XFF503494) : Color(0XFF6E758A),
                                                width: 1.w),
                                          ),
                                          child: Text(
                                            categoryList[i],
                                            style: selectedCategory.contains(categoryList[i])
                                                ? TextStyle(
                                                    fontSize: 15.sp, fontWeight: FontWeight.w700, color: Color(0XFF503494), fontFamily: 'Gilroy')
                                                : TextStyle(
                                                    fontSize: 15.sp, fontWeight: FontWeight.w700, color: Color(0XFF6E758A), fontFamily: 'Gilroy'),
                                          ),
                                        ),
                                      ),
                                    ],
    ...
    return Container(
      ...
      child: TextFormField(
          decoration: InputDecoration(
              focusedBorder:
                  OutlineInputBorder(borderSide: BorderSide(color: Color(0XFF503494), width: 1.w), borderRadius: BorderRadius.circular(22.h)),
              hintText: 'Search',
              hintStyle: TextStyle(color: const Color(0XFF9B9B9B), fontSize: 15.sp, fontFamily: 'Gilroy', fontWeight: FontWeight.w400),
              prefixIcon: Image(
            ...
            return Stack(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    design[index].name!,
                    style: TextStyle(color: Color(0XFF000000), fontSize: 14.sp, fontFamily: 'Gilroy', fontWeight: FontWeight.w700),
                  ),
                )
              ],
            );
        ...
        itemBuilder: (BuildContext context, int index) {
          return Container(
            ...
            decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(color: const Color(0XFF503494).withOpacity(0.14), offset: const Offset(0, 1), blurRadius: 5.h),
                ],
            ...
            child: Column(
              children: [
                Container(
                  ...
                  width: 190.w,
                  decoration: BoxDecoration(
                    image: DecorationImage(image: AssetImage(cource[index].image!), fit: BoxFit.cover),
                    borderRadius: BorderRadius.circular(12.h),
                    boxShadow: [
                  ...
                  child: Padding(
                    padding: EdgeInsets.only(top: 10.h, left: 10.w, bottom: 130.h, right: 130.w),
                    child: Container(
                        height: 30.h,
                        width: 30.w,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(fontSize: 14.sp, fontWeight: FontWeight.w700, fontFamily: 'Gilroy', color: Color(0XFF000000)),
                      ),
                      Padding(
                            ...
                            Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    cource[index].review!,
                                    style: TextStyle(color: const Color(0XFFFFC403), fontFamily: 'Gilroy', fontSize: 14.sp),
                                  ),
                                ],
                              ),
                            ),
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Text(
                                      cource[index].time!,
                                      style: TextStyle(
                                          fontSize: 13.sp, color: const Color(0XFF000000), fontWeight: FontWeight.w400, fontFamily: 'Gilroy'),
                                    )
                                  ],
                                ),
                              ),
                      ...
                      Row(
                        children: [
                          ...
                          Text(
                            ...
                            style: TextStyle(color: const Color(0XFF503494), fontSize: 14.sp, fontFamily: 'Gilroy'),
                          )
                        ],
                      )
                    ],
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(fontWeight: FontWeight.w700, fontSize: 15.sp, color: const Color(0XFF000000), fontFamily: 'Gilroy'),
                    ),
                  ),
                  SizedBox(height: 11.h),
                  Padding(
                        ...
                        Row(
                          children: [
                            ...
                            Text(
                              ...
                              style: TextStyle(fontFamily: 'Gilroy', fontWeight: FontWeight.w400, color: const Color(0XFF503494), fontSize: 15.sp),
                            ),
                          ],
                        ),
                        Container(
                          ...
                          child: Center(
                            ...
                            style: TextStyle(color: Color(0XFF503494), fontFamily: 'Gilroy', fontSize: 19.sp, fontWeight: FontWeight.w400),
                          )),
                        )
                      ],
                    ),
