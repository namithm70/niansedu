...
class TodaysStudyPlanDataModel {
  bool? success;
  String? message;
  Data? data;

  TodaysStudyPlanDataModel({this.success, this.message, this.data});

  TodaysStudyPlanDataModel.fromJson(Map<String, dynamic> json) {
...
class StudyPlans {
  ...
  StudyPlans({this.pkIntStudyPlansId, this.courseId, this.batchId, this.studyPlansDate, this.createdAt, this.updatedAt, this.items});
