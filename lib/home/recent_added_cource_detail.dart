            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  SizedBox(width: 15.w),
                  Flexible(
                    child: Text("${widget.corcedetail.title}",
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Text(
                                        ...
                                        style:
                                            TextStyle(fontFamily: 'Gilroy', color: Color(0XFF6E758A), fontSize: 15.sp, fontWeight: FontWeight.w700),
                                      ),
                                      Container(
                                          height: 23.h,
                                          width: 53.w,
                                ...
                                Container(
                                    ...
                                    child: Center(
                                      child: Text(
                                        ...
                                        style:
                                            TextStyle(color: Color(0XFF503494), fontSize: 15.sp, fontFamily: 'Gilroy', fontWeight: FontWeight.w700),
                                      ),
                                    )),
                                Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    ...
                                    Text(cource_detail[index].lessonName!,
                                        style:
                                            TextStyle(color: Color(0XFF000000), fontSize: 14.sp, fontFamily: 'Gilroy', fontWeight: FontWeight.bold)),
                                  ...
                                  children: [
                                    index < 3
                                        ? GestureDetector(
                                            ...
                                            onTap: () {
                                              Navigator.push(
                                                  context, MaterialPageRoute(builder: (context) => VidioPlay(lessonplay: cource_detail[index])));
                                            },
                                          )
                                        : GestureDetector(
                                            child: Image(
