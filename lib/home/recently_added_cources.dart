            ...
            child: Row(
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(fontSize: 24.sp, color: Color(0XFF000000), fontFamily: 'Gilroy', fontWeight: FontWeight.bold),
                ),
              ],
            ),
          ),
                              ...
                              child: Stack(
                                children: [
                                  Container(
                                    ...
                                    decoration: BoxDecoration(borderRadius: BorderRadius.circular(20.h), color: Colors.white),
                                    child: Image(
                                      image: AssetImage(recentcource[index].image!),
                                      fit: BoxFit.fill,
                                    ),
                                  ),
                                  Padding(
                                    ...
                                    child: Container(
                                        ...
                                        child: IconButton(
                                            splashRadius: 10.h,
                                            onPressed: () {},
                                            icon: const Center(child: Image(image: AssetImage("assets/saveicon.png"))))),
                                  ),
                                  Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        ...
                                        style: TextStyle(color: Color(0XFFFFC403), fontFamily: 'Gilroy', fontSize: 15.sp),
                                      ),
                                    ],
                                  ),
                                ),
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Text(
                                        ...
                                        style: TextStyle(fontSize: 15.sp, color: const Color(0XFF000000), fontFamily: 'Gilroy'),
                                      )
                                    ],
                                  ),
                                ),
                          ...
                          children: [
                            Padding(
                              ...
                              child: Text(
                                ...
                                style: TextStyle(fontWeight: FontWeight.w700, fontSize: 15.sp, fontFamily: 'Gilroy', color: Color(0XFF000000)),
                              ),
                            ),
                            SizedBox(height: 11.h),
                            Row(
                              ...
                              children: [
                                Row(
                                  children: [
                                    Image(
                                      image: AssetImage(recentcource[index].circleimage!),
                                      height: 40.h,
                                      width: 40.w,
                                    ),
                                    SizedBox(width: 10.w),
                                    Text(
                                      ...
                                      style: TextStyle(color: Color(0XFF503494), fontSize: 15.sp, fontWeight: FontWeight.w400, fontFamily: 'Gilroy'),
                                    )
                                  ],
                                ),
                                Row(
                                  children: [
                                    Container(
                                      height: 30.h,
                                      width: 74.w,
                                      decoration: BoxDecoration(borderRadius: BorderRadius.circular(12.h), color: const Color(0XFFE5ECFF)),
                                      child: Center(
                                          child: Text(
                                        recentcource[index].price!,
                                        style: TextStyle(
                                            color: const Color(0XFF503494), fontFamily: 'Gilroy', fontSize: 19.sp, fontWeight: FontWeight.w700),
                                      )),
                                    )
                                  ],
                                ),
