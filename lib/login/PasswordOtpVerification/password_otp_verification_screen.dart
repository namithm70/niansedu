...
import 'package:edxera/login/PasswordOtpVerification/Controllers/password_otp_controller.dart';
...
class PasswordOtpVerification extends StatefulWidget {
  const PasswordOtpVerification({super.key});

  @override
  State<PasswordOtpVerification> createState() => _PasswordOtpVerificationState();
}

class _PasswordOtpVerificationState extends State<PasswordOtpVerification> {
  final otpkey = GlobalKey<FormState>();

  PasswordOtpController controller = Get.put(PasswordOtpController());
    ...
    return Center(
      ...
      onTap: () {
        ...
        controller.otp.value != ''
            ? controller.verificationCodeApi(controller.emailid)
