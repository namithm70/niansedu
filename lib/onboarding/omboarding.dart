        ...
        children: List.generate(pages.length, (index) {
          return AnimatedContainer(
            ...
            decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(5.h), color: (index == currentpage) ? const Color(0XFF503494) : const Color(0XFFDEDEDE)),
          );
        }));
  }
  ...
  Widget button() {
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(borderRadius: BorderRadius.circular(22.h), color: const Color(0XFF503494)),
            ...
            child: GestureDetector(
                ...
                child: Container(
                    ...
                    child: Center(
                      ...
                      "Skip",
                      style: TextStyle(
                          fontFamily: 'Gilroy', fontWeight: FontWeight.bold, fontStyle: FontStyle.normal, fontSize: 15.sp, color: Color(0xFF000000)),
                    )))),
          );
  }
        ...
        itemBuilder: (context, index) {
          return Column(
            ...
            children: [
              ...
              Text(
                pages[index].name!,
                style: TextStyle(fontFamily: 'Gilroy', fontWeight: FontWeight.w700, color: Color(0XFF000000), fontSize: 22.sp),
              ...
              Padding(
                ...
                child: Text(
                  pages[index].title!,
                  style: TextStyle(fontFamily: 'Gilroy', fontWeight: FontWeight.w700, color: Color(0XFF000000), fontSize: 15.sp),
                  textAlign: TextAlign.center,
                ),
              )
            ],
